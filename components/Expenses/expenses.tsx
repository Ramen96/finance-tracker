            ...
            <section key={category.name} className={styles.categorySection}>
              ...
              <div className={styles.expensesTable}>
                ...
                <div className={styles.tableBody}>
                  {expenses.map((expense) => (
                    <div key={expense.id} className={styles.tableRow}>
                      <span className={styles.descriptionCol}>{expense.description}</span>
                      <span className={styles.amountCol}>${expense.amount.toLocaleString()}</span>
                ...
                <div className={styles.categoryTotal}>
                  ...
                  <span className={styles.totalAmount}>${categoryTotal.toLocaleString()}</span>
                </div>
              </div>
            </section>
          );
